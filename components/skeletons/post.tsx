    ...
    <article className="xl:w-[1000px] w-[95%] mx-auto post-content">
      <header className={`w-full lg:w-blog mx-auto`}>
        <div className="animate-pulse">
          <div className="h-8 bg-gray rounded w-3/4 lg:w-1/2 mb-2"></div>
          <div className="h-4 bg-gray rounded w-1/4 lg:w-1/6"></div>
        </div>
      </header>
      <div className="animate-pulse mt-5 max-h-[650px] rounded-lg bg-gray h-[650px]"></div>
