  ...
  try {
    ...
    switch (block.type) {
      ...
      case 'embed': {
        ...
        const isX = embedUrl.startsWith("https://x.com/") || embedUrl.startsWith("https://www.x.com/") || embedUrl.startsWith("https://twitter.com/") || embedUrl.startsWith("https://www.twitter.com/");

        if (!isX) {
          // Skip if its not X embeds
          return null;
        }
